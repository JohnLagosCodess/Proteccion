...
$(document).ready(function(){
    ...
    if (predeterminado_concepto_jrci == "Desacuerdo") {
        ...
        $("#Asunto").val(controversia.desacuerdo.Asunto);
        console.log(controversia.desacuerdo.Asunto);
       ...
       /* Evaluamos el tipo de controversia para saber que texto hay que insertar en la proforma. */
        if (id_tipo_controversia == 12) {
            ...
            var texto_insertar = controversia.desacuerdo.Texto_insertar;;
        }
        ...
        $("#Asunto").val(controversia.acuerdo.Asunto);
        ...
        if (id_tipo_controversia == 12) {
            ...
            var texto_insertar = controversia.acuerdo.Texto_insertar;
