$(document).ready(function(){
    ...
    $("#btn_agregar_parametrizacion_origen_atel").click(function(){
        ...
        var nueva_fila_parametrizacion_origen_atel = [
            ...
            `<textarea style="width:140px;" class="form-control" id="firmeza_${contador_origen_atel}" cols="150" rows="4" ></textarea>`,
            `<textarea style="width:140px;" class="form-control" id="estado_firmerza_${contador_origen_atel}" cols="150" rows="4" ></textarea>`,
            `<textarea style="width:140px;" class="form-control" id="dictamen_firme_${contador_origen_atel}" cols="150" rows="4" ></textarea>`,
    ...
    $("#btn_agregar_parametrizacion_calificacion_pcl").click(function(){
        ...
        var nueva_fila_parametrizacion_calificacion_pcl = [
            ...
            `<textarea style="width:140px;" class="form-control" id="firmeza_${contador_calificacion_pcl}" cols="150" rows="4" ></textarea>`,
            `<textarea style="width:140px;" class="form-control" id="estado_firmerza_${contador_calificacion_pcl}" cols="150" rows="4" ></textarea>`,
            `<textarea style="width:140px;" class="form-control" id="dictamen_firme_${contador_calificacion_pcl}" cols="150" rows="4" ></textarea>`,
    ...
    $("#btn_agregar_parametrizacion_juntas").click(function(){
        ...
        var nueva_fila_parametrizacion_juntas = [
            ...
            `<textarea style="width:140px;" class="form-control" id="firmeza_${contador_juntas}" cols="150" rows="4" ></textarea>`,
            `<textarea style="width:140px;" class="form-control" id="estado_firmerza_${contador_juntas}" cols="150" rows="4" ></textarea>`,
            `<textarea style="width:140px;" class="form-control" id="dictamen_firme_${contador_juntas}" cols="150" rows="4" ></textarea>`,
