                                ...
                                <form id="form_guardarEmitidoJrci" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <br>
                                                <label for="f_noti_dictamen_jrci">Fecha aviso recolección dictamen (JRCI)<span style="color: red;">(*)</span></label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <br>
                                                <label for="f_radica_dictamen_jrci">Fecha recolección dictamen (JRCI)<span style="color: red;">(*)</span></label>
                            ...
                            <div class="card-body">
                                <form id="form_guardarReposicionJRCI" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="f_noti_dictamen_reposicion_jrci">Fecha aviso recolección dictamen (Reposición JRCI)</label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="f_radica_dictamen_reposicion_jrci">Fecha recolección dictamen (Reposición JRCI)</label>
                            ...
                            <div class="card-body">
                                <form id="form_guardarActaEjecuJrci" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="f_acta_ejecutoria_emitida_jrci">Fecha recepción acta ejecutoría (JRCI) <span style="color: red;">(*)</span></label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="f_firmeza_dictamen_jrci">Fecha acta ejecutoría (JRCI) <span style="color: red;">(*)</span></label>
                                ...
                                <form id="form_guardarEmitidoJnci" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <br>
                                                <label for="f_noti_ante_jnci">Fecha aviso recolección dictamen (JNCI)</label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <br>
                                                <label for="f_radica_dictamen_jnci">Fecha recolección dictamen (JNCI)</label>
