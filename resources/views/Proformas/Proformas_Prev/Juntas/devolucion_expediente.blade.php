    ...
    <div id="footer">        
        <?php if($footer == null): ?>
            <div style="text-align:center;">
                <span style="color: #3C3C3C; margin-top:2px;">{{$nombre_beneficiario}} - {{$tipo_documentos_benefi}} {{$nro_identificacion_benefi}} - SINIESTRO: {{$N_siniestro}} </span>
            </div>        
        <?php else: ?>
            <?php 
            ...
            <div class="footer_content" style="text-align:center;">
                <span style="position: absolute; width: 100%; text-align:center; top: 10px; left:0px; color:#4D4D4D; font-weight:bold; font-size: 11px;">
                    {{$nombre_beneficiario}} - {{$tipo_documentos_benefi}} {{$nro_identificacion_benefi}} - SINIESTRO: {{$N_siniestro}}                     
                </span>
    ...
    <div class="container">        
        ...
        <section class="fuente_todo_texto" style="margin-bottom: 2em; text-align: justify;">                       
            <?php 
                ...
                $patron5 = '/\{\{\$fecha_envio_jrci\}\}/'; 
                $patron6 = '/\{\{\$nombre_junta\}\}/';                               
                ...
                if (preg_match($patron1,$cuerpo) && preg_match($patron2,$cuerpo) && preg_match($patron3,$cuerpo)
                    ...
                    $texto_modificado = str_replace('{{$fecha_envio_jrci}}', $fecha_envio_jrci, $texto_modificado);
                    $texto_modificado = str_replace('{{$nombre_junta}}', $nombre_junta_jrci, $texto_modificado);
