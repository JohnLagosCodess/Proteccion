...
@section('title', 'Reporte Trazabilidad Juntas')
...
@section('content')
    <div class="card-info" style="border: 1px solid black;">
        <div class="card-header text-center">
            ...
            <h5 style="font-style: italic;">Reporte Trazabilidad Juntas</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="card-info">
                        <div class="card-header text-center" style="border: 1.5px solid black;">
                            <h5>Trazabilidad Juntas</h5>
                        </div>
                        <div class="card-body">
                            <form id="form_consulta_repor_traza_juntas" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-4">
                            ...
                            <form id="descargar_repor_traza_juntas" method="POST">
                                @csrf
                                <br>
...
@section('js')
    <script src="/js/reporte_trazabilidad_juntas.js"></script>
@stop