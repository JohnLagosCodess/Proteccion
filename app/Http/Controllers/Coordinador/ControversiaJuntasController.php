...
class ControversiaJuntasController extends Controller
{
    ...
    public function mostrarVistaPronunciamientoJuntas(Request $request){
        ...
        'array_datos_diagnostico_motcalifi_emitido_jnci',
        ...
        'cantidad_documentos_cargados','arraylistado_documentos','Id_Asignacion','entidades_conocimiento', 'info_afp_conocimiento'));
    ...
    public function DescargarProformaRecursoReposicion(Request $request){
        ...
        if($request->tipo_proforma == "pdf"){
            $datos_proforma = [
                ...
                "origen_jrci" => mb_strtoupper($datos_tipo_controversia[0]->Nombre_parametro, 'UTF-8') ?? null,
