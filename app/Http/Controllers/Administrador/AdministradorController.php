...
class AdministradorController extends Controller
{
    ...
    public function actualizarGestionInicial(Request $request){
        ...
        if($entidades_conocimiento_actuales){
            ...
            foreach ($actuales_entidades_conocimiento as $index => $id) {
                ...
                if($flag_cambio){
                    $tipo_correspondencia = $index === 0 ? "afp_conocimiento" : "afp_conocimiento" . ($index + 1);
        ...
        if ($objetoconvertido['Tipo_empleado'] == 'Independiente' || $objetoconvertido['Tipo_empleado'] == 'Beneficiario') {
            ...
            ->where('ID_evento', $IdEventoactulizar)->firstOrFail();
            // $laboral Actualizar->fill($actualizar_GestionInicialLaboral);
        ...
        'siae.Id_municipio', 'sldm1.Nombre_municipio', 'siae.Ocupacion', 'siae.Tipo_afiliado', 'slp_tipo_afiliado.Nombre_parametro as Nombre_tipo_afiliado',
        'siae.Ibc', 'siae.Id_eps', 'sle.Nombre_entidad as Nombre_eps', 'siae.Id_afp', 'sle1.Nombre_entidad as Nombre_afp', 'siae.Id_arl', 'sle2.Nombre_entidad as Nombre_arl',
        'siae.Entidad_conocimiento', 'siae.Id_afp_entidad_conocimiento', 'siae.Id_afp_entidad_conocimiento2', 'siae.Id_afp_entidad_conocimiento3', 'siae.Id_afp_entidad_conocimiento4', 'siae.Id_afp_entidad_conocimiento5', 'siae.Id_afp_entidad_conocimiento6', 'siae.Id_afp_entidad_conocimiento7', 'siae.Id_afp_entidad_conocimiento8',
        'siae.Tipo_documento_apoderado','slp_tipo_doc_apoderado.Nombre_parametro as Nombre_documento_apoderado',
        'siae.Apoderado', 'siae.Nombre_apoderado','siae.Nro_identificacion_apoderado', 'siae.Email_apoderado','siae.Telefono_apoderado', 'siae.Direccion_apoderado', 'siae.Id_departamento_apoderado', 'siae.Id_municipio_apoderado', 
        'sldm_apoderado.Nombre_departamento as Nombre_departamento_apoderado', 'sldm1_apoderado.Nombre_municipio as Nombre_municipio_apoderado',
        'siae.Activo', 'siae.Medio_notificacion','siae.Nombre_afiliado_benefi','Nro_identificacion_benefi', 
    ...
    private function registrar_bitacora(Request $request, $bitacora)
    {
        $map_evento = [
            ...
            "activador" => ["info:i_activador","bitacora:Activador"],
            "n_radicado_hc" => ["bitacora:N_Radicado_HC"],
            ...
            "tipo_documento_apoderado" => ["info:t_documento","bitacora:Tipo_de_documento_apoderado"],
            "email_apoderado" => ["bitacora:Email_del_apoderado"],
            "telefono_apoderado" => ["bitacora:Telefono_del_apoderado"],
            "direccion_apoderado" => ["bitacora:Dirección_del_apoderado"],
            "id_departamento_apoderado" => ["info:departamento","bitacora:Departamento_apoderado"],
            "id_municipio_apoderado" => ["info:ciudad","bitacora:Ciudad_apoderado"],
